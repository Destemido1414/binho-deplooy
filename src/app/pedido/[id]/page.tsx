    ...
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-[2fr,1.2fr]">
        ...
        <aside className="space-y-3 rounded-2xl border bg-white p-5 text-sm text-zinc-700">
          ...
          <p>
            Em caso de qualquer dúvida sobre pagamento, entrega ou peças do
            pedido, fale diretamente com a loja pelo WhatsApp informando o ID do
            pedido.
          </p>
          <Link
          ...
          <div className="pt-2 text-xs text-zinc-500">
            Endereço da loja: Rua 8, nº 84 – Jardim Vicente de Carvalho 2,
            Bertioga – São Paulo.
          </div>
        </aside>
      </div>
